...
function TrackOrder() {
  ...
  if (searchScope === "catalogue" && searchKeyword.trim() !== "") {
  ...
  if (searchKeyword.trim() !== "") {
    ...
    filteredProducts = filteredProducts.filter((product) => {
      ...
      if (searchDescription) {
        return author.includes(keyword) || description.includes(keyword);
      }
  ...
  const currentProducts = [...filteredProducts].sort((a, b) => {
    if (activeFilter === "low-high") return Number(a.price) - Number(b.price);

    if (activeFilter === "high-low") return Number(b.price) - Number(a.price);
            ...
            <div>
              ...
              <Row className="align-items-start mb-5 gy-3">
                ...
                <Col
                  xs={12}
                  md={6}
                  className="d-flex flex-column align-items-md-end text-dark"
                >
                ...
                <>
                  ...
                  {activeCategory === "West Indies Books" && (
                    ...
                    >
                      ...
                      <p>
                        Post and packing is extra. Orders are packed carefully
                        and covered by my insurance. Costs are kept to a
                        minimum.
                      </p>
                    </div>
                  )}
                  ...
                  {activeCategory === "Philatelic Books" && (
                    ...
                    >
                      <p className="mb-3">
                        Books on philately for sale. Post and packing is extra.
                        Costs are kept to a minimum.
                      </p>
                      <p>
                        To view the Philatelic Books of{" "}
                        <a
                          href="#"
                          style={{
                            color: "black",
                        ...
                        >
                          W.I.P.S.G. publications, click here
                        </a>
                      </p>
                    </div>
                  )}
                  ...
                  {activeCategory === "Maps, Prints, Photographs Ephemera" && (
                    ...
                    >
                      <div className=" mb-4">
                        ...
                        >
                          All maps and prints are guaranteed originals. I do not
                          sell reproductions.
                        </span>
                      </div>
                      <p className="text-start">
                        Maps and prints of the World for sale. My stock is
                        mostly concentrated on the Caribbean. You will also find
                        old photographs and posters here. I am keen to purchase
                        fine engraved West Indies prints and C17th and C18th
                        Caribbean maps.
                      </p>
                      ...
                      <p
                        className="mb-0 text-muted small text-start"
                        style={{ fontStyle: "italic" }}
                      >
                        Images have been cropped close to the frame of the map
                        to keep file sizes reasonably small. Actual margins will
                        be greater unless noted in the description.
                      </p>
                    </div>
                  )}
                  ...
                  {activeCategory === "Old Picture Postcards" && (
                    ...
                    >
                      <p className="mb-4 text-start">
                        Old picture postcards from the Caribbean islands for
                        sale plus a few collectable cards from around the World.
                        Post and packing is extra but does not increase however
                        many items are ordered. Inland £1, Europe and Overseas
                        £3
                      </p>
                    </div>
                  )}
            ...
            <div className="d-flex flex-wrap gap-2 mt-4 mb-5">
              {[
                ...
                <button
                  ...
                  style={{
                    backgroundColor:
                      activeFilter === btn.id ? "#803300" : "transparent",
      ...
      {searchScope === "catalogue"
        ...
        : activeCategory}
            ...
            {activeCategory === "West Indies Books" && (
              ...
              >
                <h4 className="fw-bold mb-4" style={{ fontSize: "1.25rem" }}>
                  Links to other West Indies sites
                </h4>
                <div className="mb-4">
                  <h5 style={{ fontSize: "1.05rem", fontWeight: "bold" }}>
                    Family history of Jamaica
                  </h5>
                  <a
                    href="http://www.mymynton.com/index.htm"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ color: "blue", textDecoration: "underline" }}
                  >
                    http://www.mymynton.com/index.htm
                  </a>
                  <p className="mt-2">
              ...
              >
                ...
                <div className="mb-3">
                  ...
                  <p className="mt-2" style={{ fontSize: "1rem" }}>
                    (Regular journal with articles on stamps and postal history
                    plus meetings around the world.)
                  </p>
                </div>
              </div>
            )}
            ...
            {activeCategory === "Maps, Prints, Photographs Ephemera" && (
              ...
              >
                <h4 className="mb-4" style={{ fontSize: "0.9rem" }}>
                  Links to other websites of interest:
                </h4>
                <div className="mb-4">
                  <p style={{ fontSize: "0.9rem", marginBottom: "8px" }}>
                    Caribbean Photo Archive - Many old photos sorted by islands
                    plus video clips from old home movies
                  </p>
                  <a
                    href="http://www.caribbeanphotoarchive.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="mb-3">
                  <p style={{ fontSize: "0.9rem", marginBottom: "8px" }}>
                    Caribmap - A Cartographic history of the Caribbean Islands
                  </p>
                  <a
                    href="http://www.caribmap.org/"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          >
            ...
            >
              Please enter your Email address to confirm your identity and
              receive details about your orders.
            </p>
            ...
            {!verified ? (
              ...
              <div style={{ marginTop: "20px" }}>
                <h4 style={{ fontFamily: "Georgia, serif", color: "#803300" }}>
                  Your Orders
                </h4>
                <p className="text-muted">
                  Showing order status information for: {email}
                </p>

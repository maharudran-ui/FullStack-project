// src/components/features/WestindiesBooksCard.jsx
  ...
  return (
    <Card className="border-0 text-center product-card h-100">
      <div className="product-img-frame" style={{ background: "#fff", padding: "15px" }}>
        <Card.Img variant="top"src={book.image} className="product-image"style={{ maxHeight: "200px", objectFit: "contain" }}/>
      </div>
      <Card.Body className="d-flex flex-column justify-content-between">
        ...
        <button 
          className="btn btn-sm mt-3 w-100 text-white" 
          style={{ backgroundColor: "#803300" }}
